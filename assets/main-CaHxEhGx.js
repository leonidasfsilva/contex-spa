          ...
          <div class="flex items-center gap-2">
            ...
            <div class="relative" data-dropdown>
              <button type="button" data-dropdown-trigger aria-label="User menu" aria-expanded="false"
                class="ms-1 flex h-8 w-8 items-center justify-center rounded-full bg-primary/10 text-xs font-semibold text-primary transition-colors hover:bg-primary/20">AS</button>
              <div data-dropdown-panel hidden
                ...
                <div class="px-2 py-1.5">
                  <p class="text-sm font-medium">Aigars S.</p>
                  <p class="text-xs text-muted-foreground">aigars@example.com</p>
                </div>
                ...
                <div class="my-1 h-px bg-border"></div>
                <a href="auth/login.html" class="flex items-center rounded-md px-2 py-1.5 text-sm transition-colors hover:bg-accent">
